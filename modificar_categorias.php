  ...
  <section class="contenedorinicio1">
	...
	<form method="POST" action="grabar_categorias.php"  >
		...
		<fieldset>
			...
			<input class="camponumero" type="text" name="cat_codigo" size="5px" readonly maxlength="3" value="<?php echo $codigo ?>">
			</div>
			<br>		
	        <div>
			<label class="titulo"><h7>*</h7> nombre</label>
			<input class="campo" type="text" name="cat_nombre" size="24px" autofocus  maxlength="100" value="<?php echo $nombre ?>">
	        </div>
	        <br>
	 ...
	 ?>
	  <script type="text/javascript">alert("MODIFIQUE LA CATEGORIA <?php echo $mensaje; ?>");</script>
