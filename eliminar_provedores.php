  ...
  <section class="contenedorinicio1">
	...
	<form method="POST" action="grabar_provedores.php"  >
		...
		<fieldset>
			...
			<input class="camponumero" type="text" name="prove_codigo" size="5px" readonly maxlength="5" value="<?php echo $codigo ?>">
			</div>
			<br>		
	        <div>
			<label class="titulo"><h7>*</h7> nombre</label>
			<input class="campo" type="text" name="prove_nombre" size="24px" readonly  maxlength="15" value="<?php echo $nombre ?>">
	        </div>
	        <br>
	 ...
	 ?>
	  <script type="text/javascript">alert(" ELIMINE EL PROVEDOR <?php echo $mensaje; ?>");</script>
