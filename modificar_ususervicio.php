...
<body class="cuerpo">
 <center>
  ...
  <ul>
    ...
    <br/>
  <br/> 
  <h1>Edicion De usuarios del servicio</h1>
 ...
 <form action="grabar_ususervicio.php" method="POST">
    ...
    <fieldset>
      ...
      <input class="camponumero" type="number" name="ususer_documento" size="10px" autofocus  maxlength="10" value="<?php echo $codigo ?>">
      </div>
      <br>
          <div>
      <label class="titulo"><h7>*</h7>Apellidos</label>
      <input class="campo" type="text" name="ususer_apellidos" size="24px" autofocus required maxlength="100" value="<?php echo $apellidos ?>">
          </div>
          <br>
          <div>
      <label class="titulo"><h7>*</h7>Nombres</label>
      <input class="campo" type="text" name="ususer_nombres" size="24px" autofocus required maxlength="100"  value="<?php echo $nombres ?>">
          </div>
          <br>
          <div>
      <label class="titulo"><h7>*</h7> Direccion</label>
      <input class="campo" type="text" name="ususer_direccion" size="24px" autofocus required maxlength="100"  value="<?php echo $direccion ?>">
          </div>
          <br>
          <div>
      <label class="titulo"><h7>*</h7> Telefono</label>
      <input class="camponumero" type="number" name="ususer_telefono" size="30px" autofocus required maxlength="10" value="<?php echo $telefono ?>">
          </div>
          <br>
   ...
   ?>
    ...
    <script type="text/javascript">alert(" MODIFIQUE LOS DATOS DEL USUARIO DEL SERVICIO <?php echo $mensaje; ?>");</script>
