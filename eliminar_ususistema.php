...
<?php 
	...
	$sSQL = "SELECT * FROM usuarios_sistema WHERE ususis_documento =?";
	...
	try 
	{
		...
		$apellidos = $fila['ususis_apellidos'];
    $nombres = $fila['ususis_nombres'];
    $direccion = $fila['ususis_direccion'];
    $cargo = $fila['ususis_cargo'];
    $pais = $fila['ususis_pais'];
    $telefono = $fila['ususis_telefono'];
...
<body class="cuerpo">
 <center>
  ...
  <ul>
    ...
    <br/>
  <br/> 
  <h1>Eliminasion De usuarios del sistema</h1>
 ...
 <form action="grabar_ususistema.php" method="POST">
    ...
    <fieldset>
      ...
      <input class="camponumero" type="number" name="ususis_documento" size="10px" readonly  maxlength="10" value="<?php echo $codigo ?>">
      </div>
      <br>
          <div>
      <label class="titulo"><h7>*</h7>Apellidos</label>
      <input class="campo" type="text" name="ususis_apellidos" size="24px" readonly maxlength="100" value="<?php echo $apellidos ?>">
          </div>
          <br>
          <div>
      <label class="titulo"><h7>*</h7>Nombres</label>
      <input class="campo" type="text" name="ususis_nombres" size="24px" readonly maxlength="100"  value="<?php echo $nombres ?>">
          </div>
          <br>
          <div>
      <label class="titulo"><h7>*</h7> Direccion</label>
      <input class="campo" type="text" name="ususis_direccion" size="24px" readonly maxlength="100"  value="<?php echo $direccion ?>">
          </div>
          <br >
          <div>
      <label class="titulo"><h7>*</h7> cargo</label>
      <input class="campo" type="text" name="ususis_cargo" size="24px" readonly maxlength="50"  value="<?php echo $cargo ?>">
          </div>
          <br>
        <div>
      <label class="titulo"><h7>*</h7> pais</label>
      <input class="camponumero" type="text" name="selPai"  size="20" maxlength="25" readonly value="<?php echo $pais ?>">
         </div>
          <br>          
          <div>
      <label class="titulo"><h7>*</h7> Telefono</label>
      <input class="camponumero" type="number" name="ususis_telefono" readonly size="30px" maxlength="10" value="<?php echo $telefono ?>">
          </div>
          <br>
   ...
   ?>
    ...
    <script type="text/javascript">alert(" ELIMINE LOS DATOS DEL USUARIO DEL SISTEMA <?php echo $mensaje; ?>");</script>
