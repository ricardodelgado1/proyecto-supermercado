<?php 
 ...
 <?php 
	...
	$sSQL = "SELECT * FROM categorias WHERE cat_codigo =?";
...
<center>
  ...
  <section class="contenedorinicio1">
	...
	<ul>
  	...
  	<br/>
	<br/>	
	<h1>ELIMINASION DE PROVEDORES</h1>
	...
	<form method="POST" action="grabar_categorias.php"  >
		...
		<fieldset>
			...
			<input class="camponumero" type="text" name="cat_codigo" size="5px" readonly maxlength="5" value="<?php echo $codigo ?>">
			</div>
			<br>		
	        <div>
			<label class="titulo"><h7>*</h7> nombre</label>
			<input class="campo" type="text" name="cat_nombre" size="24px" readonly  maxlength="15" value="<?php echo $nombre ?>">
	        </div>
	        <br>
	 ...
	 ?>
	  <script type="text/javascript">alert(" ELIMINE LA CATEGORIA<?php echo $mensaje; ?>");</script>
