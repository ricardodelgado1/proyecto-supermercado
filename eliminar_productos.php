...
<body class="cuerpo">
 <center>
  ...
  <ul>
    ...
    <br/>
    <br/> 
  <h1>Eliminasion De Productos</h1>



  <form action="grabar_productos.php" method="POST">
    ...
    <fieldset>
      ...
      <input class="campo" type="text" name="prod_nombre" size="24px" readonly  value="<?php echo $nombre ?>">
          </div>
          <br>
          <div>
      <label class="titulo"><h7>*</h7> Fecha de Ingreso</label>
      <input class="campo" type="date" name="prod_fecha" size="5px" readonly value="<?php echo $fecha ?>">
          </div>
          <br>
          <div>
      <label class="titulo"><h7>*</h7> Categoria</label>   
      <input class="camponumero" type="text" name="selcat"  size="20"   readonly value="<?php echo $categoria ?>">                                             
          </div> 
          <br> 
          <div>
      <label class="titulo"><h7>*</h7> Provedor</label>  
      <input class="camponumero" type="text" name="selprov"  size="20"  readonly value="<?php echo $provedor ?>">                     
          </div> 
          <br>
          <div>
      <label class="titulo"><h7>*</h7> Precio</label>
      <input class="camponumero" type="number" name="prod_precio" size="24px" readonly value="<?php echo $precio ?>">
          </div>
          <br>
          <div>
      <label class="titulo"><h7>*</h7> Descripcion</label>
      <input class="campo" type="text" name="prod_descripcion" size="24px" readonly maxlength="100" value="<?php echo $descripcion ?>">
          </div>
           <br>
          <div>
      <label class="titulo"><h7>*</h7> Imagen</label>
      <input id="imgsub" type="file" name="imagen" size="90px" readonly value="<?php echo $imagen ?>">
          </div>
          <br>
          <br>
  ...
  <script type="text/javascript">alert(" ELIMINE EL PRODUCTO<?php echo $mensaje; ?>");</script>
