<?php 
 ...
 <?php 
	...
	$sSQL = "SELECT max(prove_codigo) as maximo from proveedores";
  ...
  <section class="contenedorinicio1">
	...
	<form method="POST" action="grabar_provedores.php"   >
		...
		<fieldset>
			...
			<input class="camponumero" type="text" name="prove_codigo" size="5px"  required maxlength="3" value="<?php echo $vrnumeromov; ?>">
			</div>
			<br>		
	        <div>
			<label class="titulo"><h7>*</h7> nombre</label>
			<input class="campo" type="text" name="prove_nombre" size="24px" autofocus required maxlength="100">
	        </div>
	        <br>
	 ...
	 ?>
	  <script type="text/javascript">alert(" INGRESE LOS DATOS DEL PROVEDOR <?php echo $mensaje; ?>");</script>
