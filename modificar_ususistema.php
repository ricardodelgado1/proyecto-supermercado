...
<body class="cuerpo">
 <center>
  ...
  <ul>
    ...
    <br/>
  <br/> 
  <h1>Edicion De usuarios del sistema</h1>
 ...
 <form action="grabar_ususistema.php" method="POST">
    ...
    <fieldset>
      ...
      <input class="camponumero" type="number" name="ususis_documento" size="10px" autofocus  maxlength="10" value="<?php echo $codigo ?>">
      </div>
      <br>
          <div>
      <label class="titulo"><h7>*</h7>Apellidos</label>
      <input class="campo" type="text" name="ususis_apellidos" size="24px" autofocus required maxlength="100" value="<?php echo $apellidos ?>">
          </div>
          <br>
          <div>
      <label class="titulo"><h7>*</h7>Nombres</label>
      <input class="campo" type="text" name="ususis_nombres" size="24px" autofocus required maxlength="100"  value="<?php echo $nombres ?>">
          </div>
          <br>
          <div>
      <label class="titulo"><h7>*</h7> Direccion</label>
      <input class="campo" type="text" name="ususis_direccion" size="24px" autofocus required maxlength="100"  value="<?php echo $direccion ?>">
          </div>
          <br >
          <div>
      <label class="titulo"><h7>*</h7> cargo</label>
      <input class="campo" type="text" name="ususis_cargo" size="24px" autofocus required maxlength="50"  value="<?php echo $cargo ?>">
          </div>
          <br>
            <div>
      ...
      <input class="camponumero" type="number" name="ususis_telefono" size="30px" autofocus required maxlength="10" value="<?php echo $telefono ?>">
          </div>
          <br>
   ...
   ?>
    ...
    <script type="text/javascript">alert(" MODIFIQUE LOS DATOS DEL USUARIO DEL SISTEMA <?php echo $mensaje; ?>");</script>
