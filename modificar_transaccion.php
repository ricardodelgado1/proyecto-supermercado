...
<center>
	...
	<form action="grabar_transacciones.php" method="POST">
		...
		<fieldset>
			...
			<input class="camponumero" type="text" name="trande_codigo" size="5px" autofocus required maxlength="5" value="<?php echo $codigo ?>">
			</div>
			<br>
	        <div>
			<label class="titulo"><h7>*</h7> Fecha</label>
			<input class="campo" type="date" name="trande_fecha" size="24px" autofocus required maxlength="10" value="<?php echo $fecha ?>">
	        </div>
	        <br>
	        <div>
			<label class="titulo"><h7>*</h7> Producto</label>
			<input class="campo" type="text" name="trande_producto" size="24px" autofocus required maxlength="10" value="<?php echo $producto ?>">
	        </div>
	        <br>
	        <div>
			<label class="titulo"><h7>*</h7> Usuario</label>
			<input class="campo" type="text" name="trande_usuario" size="24px" autofocus required maxlength="100" value="<?php echo $usuario ?>">
	        </div>
	        <br>
	        <div>
			<label class="titulo"><h7>*</h7> cantidad</label>
			<input class="camponumero" type="text" name="trande_cantidad" size="24px" autofocus required maxlength="11" id="Cantidad" value="<?php echo $cantidad ?>">
	        </div>
	        <br>
	        <div>
			<label class="titulo"><h7>*</h7> Valor Producto</label>
			<input class="camponumero" type="text" name="trande_valorproducto" size="24px" autofocus required maxlength="50" value="<?php echo $valorproducto ?>" id="Valor">
	        </div>
	        <br>
	         <div>
			<label class="titulo"><h7>*</h7> Valor Total</label>
			<input class="camponumero" type="text" name="trande_valortotal" size="24px" autofocus required maxlength="50" id="Total" value="<?php echo $valortotal ?>">
	        </div>
	        <br>
