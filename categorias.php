...
<center>
  ...
  <ul>
    ...
    <ul>
      ...
      <li><a href="listar_transacciones">Listado general de transacciones</a></li>
    ...
    <h1>PRINCIPAL CATEGORIAS</h1>
	  ...
	  <section id="cuerpo2">
				...
				<form  id="frmbuscar" method="POST" action="">
						...
						<a href="formulariocategorias.php">
				...
				if (isset($_POST['btnbuscar']))
				{
					...
					if ($campo =="todos")
					 ...
					 {
					 	$where = " WHERE cat_codigo LIKE'%$buscar%' ";
					 }	
					
					 else if ($campo =="nombre")
					 {
					 	$where = " WHERE cat_nombre LIKE'%$buscar%' ";
					 }
				
				 }

				$sSQL = "SELECT * FROM categorias".$where;
				...
				foreach( $datos as $fila)
				{
				 ...
				 echo '<tr id="contenido">';
				    ...
				    echo '<td class="imgicon">';
				       echo '<a href="modificar_categorias.php?codigo='.$fila['cat_codigo'].'"><img class="imgicon" src="imagenes/editar.png" > </a>';
				    echo '</td>';
				    echo '<td class="imgicon">';
				       echo '<a href="eliminar_categorias.php?codigo='.$fila['cat_codigo'].'"><img class="imgicon" src="imagenes/eliminar.png" > </a>';
				    echo '</td>';
