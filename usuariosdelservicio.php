	  ...
	  <section id="cuerpo2">
				...
				if (isset($_POST['btnbuscar']))
				{
					...
					if ($campo =="todos")
					 ...
					 {
					 	$where = " WHERE ususer_documento LIKE'%$buscar%' ";
					 }	
					
					 else if ($campo =="apellidos")
					 {
					 	$where = " WHERE ususer_apellidos LIKE'%$buscar%' ";
					 }

					 else if ($campo =="nombres")
					 {
					 	$where = " WHERE ususer_nombres LIKE'%$buscar%' ";
					 }
				
				 }

				$sSQL = "SELECT * FROM usuarios_servicio".$where;
				...
				foreach( $datos as $fila)
				{
				 ...
				 echo '<tr id="contenido">';
				 	echo '<td id="documento">';
				       echo $fila['ususer_documento'];
				    echo '</td>';
				    echo '<td id="apellidos">';
				       echo $fila['ususer_apellidos'];
				    echo '</td>';
				    echo '<td id="nombres">';
				       echo $fila['ususer_nombres'];
				    echo '</td>';
				    echo '<td id="direccion">';
				       echo $fila['ususer_direccion'];
				    echo '</td>';
				    echo '<td id="telefono">';
				       echo $fila['ususer_telefono'];
				    echo '</td>';				    
				    echo '<td class="imgicon">';
				       echo '<a href="modificar_ususervicio.php?codigo='.$fila['ususer_documento'].'"><img class="imgicon" src="imagenes/editar.png" > </a>';
				    echo '</td>';
				    echo '<td class="imgicon">';
				       echo '<a href="eliminar_ususervicio.php?codigo='.$fila['ususer_documento'].'"><img  class="imgicon" src="imagenes/eliminar.png" > </a>';
				    echo '</td>';
